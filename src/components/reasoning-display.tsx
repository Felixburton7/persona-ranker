...
import { ChevronDown, ChevronRight, CheckCircle2, XCircle, Building2, User, Gauge, Target, Sparkles, Filter, Ruler } from "lucide-react"
...
export function ReasoningDisplay({ lead }: ReasoningDisplayProps) {
    ...
    const scoreColor = lead.relevance_score > 80 ? "text-green-600"
        : lead.relevance_score > 50 ? "text-yellow-600"
            : "text-stone-400";
